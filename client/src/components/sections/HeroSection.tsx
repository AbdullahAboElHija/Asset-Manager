      ...
      <div className="container px-4 mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-lg md:text-xl font-medium max-w-lg border-l-4 border-primary pl-6">
          ...
          {/* Arabic Content */}
          <div className="space-y-8 text-right font-ar border-t-4 lg:border-t-0 lg:border-r-4 border-foreground pt-12 lg:pt-0 lg:pr-16">
            <div className="inline-block border-2 border-primary text-primary px-4 py-1 font-bold text-sm tracking-widest uppercase">
              إتقان رقمي
            </div>
            ...
            <p className="text-lg md:text-xl font-medium max-w-lg ml-auto border-r-4 border-primary pr-6">
